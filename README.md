...
- ⚡ **Tiempo real**: Sincronización instantánea entre todos los jugadores
...
Para reglas detalladas, consulta: [REGLAS_DEL_JUEGO.md](docs/REGLAS_DEL_JUEGO.md)

## 📚 Documentación

El proyecto incluye documentación completa en la carpeta `docs/`:

- **[REGLAS_DEL_JUEGO.md](docs/REGLAS_DEL_JUEGO.md)** - Reglas completas y ejemplos
- **[REQUERIMIENTOS_FUNCIONALES.md](docs/REQUERIMIENTOS_FUNCIONALES.md)** - 30 requerimientos funcionales
- **[REQUERIMIENTOS_NO_FUNCIONALES.md](docs/REQUERIMIENTOS_TÉCNICOS.md)** - Arquitectura y stack técnico
- **[PLAN_SCRUM.md](docs/PLAN_SCRUM.md)** - Metodología ágil y planificación

## 👥 Equipo de Desarrollo

**¡Desarrollado con ❤️ por el equipo Oh Hell!** 🃏
