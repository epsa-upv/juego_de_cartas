...
function dealCards(){
    ...
    const perPlayer=8; // por ronda
    gameState.players.forEach(p=>{
        p.hand=[]; p.tricks=0; p.bid=null;
...
window.onload=()=>{showMessage('Bienvenido a Oh Hell! Pulsa "Nuevo Juego"'); setTimeout(hideMessage,3000);}
